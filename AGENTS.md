...
- `pnpm test` must stay green: **475 tests** across 33 files (skills 36 +
  ...
  subagent-viewer 15 + history 13 + agent-manager 13 + sessions 12 +
  theme-switch 11 + frame 11 + footer-hints 10 + permission 9 +
  theme-settings 9 + commands 9 + text 8 + font-detect 8 + quotes 7 +
