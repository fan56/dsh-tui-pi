...
- `pnpm test` must stay green: **371 tests** across 27 files (live 32 +
  ...
  frame 12 + panels 9 + permission 9 + subagent-viewer 9 + sessions 8 +
  text 8 + theme-settings 8 + quotes 7 + footer-hints 9 + reload 6 +
