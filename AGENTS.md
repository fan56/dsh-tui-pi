...
- `pnpm test` must stay green: **351 tests** across 26 files (live 32 +
  keymap 27 + skills 34 + settings 19 + welcome 18 + theme 18 +
  provider-catalog 17 + hotkeys 16 + messages 15 + subagent-policy 14 +
  agent-manager 13 + history 13 + theme-canvas 12 + theme-switch 11 +
  frame 11 + panels 9 + permission 9 + subagent-viewer 9 + sessions 8 +
  text 8 + theme-settings 8 + quotes 7 + footer-hints 7 + reload 6 +
  append-system 6 + editor-theme 4). New pure
