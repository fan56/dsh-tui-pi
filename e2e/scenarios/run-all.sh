...
for s in 10-install 20-start 22-search 30-commands 40-theme 50-resize-exit 60-preset 65-ux-batch 66-retention-resume 68-ask-user 69-btw 71-cache-hit 70-steer-injection 74-profiles; do
  bash "./$s.sh"
done
