...
**Requires dsh >= 0.1.2-alpha.3** — the plugin targets the 0.1.2-alpha host line only (the rc line is no longer supported; see [ADR 0002](docs/adr/0002-target-dsh-0.1.2-alpha.3-single-target.md)).
